...
def fixed_bump_abrupt_shift(net, TARGET_1='_macro_2', TARGET_2='_macro_6', VISUAL_FR=50):
    # First Bump
    net.add_event(0, 'ChangeExtFreq', TARGET_1, 'Ach', 50)
    # Second Bump
    net.add_event(5000, 'ChangeExtFreq', TARGET_1, 'Ach', 0)
    net.add_event(5000, 'ChangeExtFreq', TARGET_2, 'Ach', VISUAL_FR)
    net.add_event(8000, 'ChangeExtFreq', TARGET_2, 'Ach', 0)
    net.add_event(8000, 'ChangeExtFreq', TARGET_1, 'Ach', 50)
    net.add_event(12001, 'EndTrial')
...
fixed_bump_abrupt_shift(net, TARGET_2=Target)
