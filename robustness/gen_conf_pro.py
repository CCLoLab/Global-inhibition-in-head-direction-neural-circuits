...
net.add_event(0, "ChangeExtFreq", "_macro_1", "Ach", VISUAL_FR)

time = 1000
for i in range(1, 8):  # micro_1 - micro_7
    net.add_event(time, "ChangeExtFreq", f"_macro_{i-1}", "Ach", 0)
    net.add_event(time, "ChangeExtFreq", f"_macro_{i}", "Ach", VISUAL_FR)
    time += 1000
net.add_event(8000, "ChangeExtFreq", "_macro_7", "Ach", 0)

net.add_event(10000, "ChangeExtFreq", "Half_PB_R", "Ach", 0)
net.add_event(10000, "ChangeExtFreq", "Half_PB_L", "Ach", PB_HALF_FR)

net.add_event(15000, "ChangeExtFreq", "Half_PB_R", "Ach", PB_HALF_FR)
net.add_event(15000, "ChangeExtFreq", "Half_PB_L", "Ach", 0)

net.add_event(20000, "ChangeExtFreq", "Half_PB_R", "Ach", 0)
net.add_event(20000, "ChangeExtFreq", "Half_PB_L", "Ach", 0)

net.add_event(22001, "EndTrial")
